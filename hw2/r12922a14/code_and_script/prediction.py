...
def parse_args():
    ...
    parser.add_argument("--prediction_jsonl", type=str, default=None)
...
def main():
    ...
    total_iterations = len(eval_dataloader)
    ...
    with jsonlines.open(args.prediction_jsonl, 'w') as writer:
        for title, id in zip(predictions, references):
