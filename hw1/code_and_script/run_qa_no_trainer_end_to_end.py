...
def main():
    ...
    if os.path.isfile(file_path):
            raise FileNotFoundError(f"File '{file_path}' already exists. Please choose a different file name or location.")
    ...
    def prepare_train_features(examples):
        ...
        contexts = []
        for paragraph_index in examples["paragraphs"]:
            all_context = ""
            for index in paragraph_index:
                all_context += context[index]
